...
while($row = mysqli_fetch_array($country)){
	...
	$query = mysqli_query($koneksi,"SELECT total_deaths FROM tb_recovery WHERE id_negara='".$row['id_negara']."'");
...
<html>
<head>
	<title>Doghnut Chart Total Deaths</title>
		...
		var config = {
			...
			data: {
				datasets: [{
					...
					label: 'Presentase Total Deaths Covid'
				}],
