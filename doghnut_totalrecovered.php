...
while($row = mysqli_fetch_array($country)){
	...
	$query = mysqli_query($koneksi,"SELECT total_recovered FROM tb_recovery WHERE id_negara='".$row['id_negara']."'");
...
<html>
<head>
	<title>Doghnut Chart Total Recovered</title>
		...
		var config = {
			...
			data: {
				datasets: [{
					...
					label: 'Presentase Total Recovered Covid'
				}],
